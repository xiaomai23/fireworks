...
const soundManager = {
	baseURL: 'https://xiaomai23.github.io/fireworks/mp3/',
	...
	playSound(type, scale=1) {
		...
		const source = this.sources[type];
		if (!source) {
		  console.error(`Sound of type "${type}" doesn't exist.`);
		  return;
		}
